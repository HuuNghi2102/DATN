...
export default function NewProductPage() {
  const newProducts = products.filter((product) => product.label === 'Hàng Mới');
    ...
    <div className="max-w-[1200px] mx-auto px-4 pt-[11%]">
      ...
      <nav className="text-[11px] font-normal text-black pb-2">
        <ul className="flex items-center gap-1">
          ...
          <li>/</li>
          <li className="font-semibold">SẢN PHẨM MỚI</li>
        </ul>
      </nav>
        ...
        {newProducts.map((product) => (
          ...
          >
            <div className="relative">
              ...
              <div
                className="absolute top-2 left-2 px-2 py-1 text-[10px] font-bold rounded text-black z-30 bg-orange-500 "
              >
                {product.label}
              </div>
              <a
