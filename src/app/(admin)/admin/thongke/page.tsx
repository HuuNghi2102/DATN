      ...
      <main className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Tổng quan hoạt động kinh doanh cửa hàng
            </p>
          </div>
        ...
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mb-6">
          {[
            ...
            <div
              key={idx}
              className="bg-white p-4 rounded shadow-sm flex items-center"
            >
              <div
                className={`w-12 h-12 flex items-center justify-center rounded-full text-white bg-${
                  item.color === "primary"
                    ? "indigo"
                    : item.color === "success"
                    ? "green"
              ...
              <tbody>
                {[
                  ...
                  <tr key={idx} className="border-b last:border-b-0">
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium bg-${order.color}-100 text-${order.color}-800`}
                      >
                        {order.status}
                      </span>
                    </td>
