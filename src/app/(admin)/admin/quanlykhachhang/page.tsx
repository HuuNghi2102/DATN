        ...
        <div className="bg-white p-6 rounded shadow mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" className="w-full border border-gray-300 rounded px-3 py-2 text-sm" placeholder="Nhập họ tên" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
              <input type="email" className="w-full border border-gray-300 rounded px-3 py-2 text-sm" placeholder="example@email.com" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Số điện thoại</label>
              <input type="text" className="w-full border border-gray-300 rounded px-3 py-2 text-sm" placeholder="Nhập số điện thoại" />
            </div>
            <div>
          ...
          <div className="flex justify-end mt-4 gap-2">
            ...
            <button className="px-4 py-2 text-sm text-white bg-indigo-600 rounded">Lưu</button>
          </div>
        </div>
      )}
              ...
              {customers.map((cus) => (
                <tr key={cus.id} className="border-t">
                  <td className="px-4 py-3 flex items-center gap-3">
                    <img src={cus.avatar} alt={cus.name} className="w-10 h-10 rounded-full object-cover" />
                    <div>
                      <div className="font-medium text-gray-800">{cus.name}</div>
