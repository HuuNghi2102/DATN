...
export default function ProductImages({images,product,typeToken,accessToken} : Props ) {
    ...
    const handleRemove = async (idImage: number) => {
        ...
        const resDeleteImage = await fetch(`https://huunghi.id.vn/api/image/deleteImage/${idImage}`,{
            method : "DELETE",
            headers : {
    ...
    const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const resAddImages = await fetch(`https://huunghi.id.vn/api/image/addImage/${product.id_san_pham}`,{
            method : "POST",
            headers : {
                "Authorization" : `${typeToken} ${accessToken}`
            },body : formData
