...
export default function AllProductPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 pt-[7rem] ipad-mini:pt-[7.5rem] ipad-air:pt-[11rem] ipad-pro:pt-[11.5rem] lg:pt-[11%]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-3 mt-2 mb-4 z-0">
        {products.map((product, index) => (
          <div key={index} className="bg-white p-2 rounded border border-gray-200 group relative">
            ...
            <div className="mt-1 text-sm font-medium text-black leading-[1.25rem]">{product.ten_san_pham}</div>
