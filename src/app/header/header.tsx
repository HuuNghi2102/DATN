      ...
      <header className={styles.header}>
        ...
        <div className={styles['main-header']}>
          ...
          <div className={styles.logo}>
            <img src="../assets/images/logo160store.png" alt="160STORE" />
          </div>
      ...
      <nav className={`${styles['mobile-nav']} ${isMobileMenuOpen ? styles.active : ''}`}>
        ...
        <ul className={styles['mobile-nav-items']}>
          {[
            ...
            {
              label: 'SẢN PHẨM',
              subItems: ['Áo Thun', 'Áo Sơ Mi', 'Áo Khoác', 'Quần Jeans', 'Quần Kaki'],
            },
            {
              label: 'ÁO NAM',
              subItems: ['Áo Thun', 'Áo Sơ Mi', 'Áo Khoác', 'Áo Polo'],
            },
            {
              label: 'QUẦN NAM',
              subItems: ['Quần Jeans', 'Quần Kaki', 'Quần Short', 'Quần Tây'],
            },
            {
              label: 'PHỤ KIỆN',
              subItems: ['Thắt Lưng', 'Ví Da', 'Túi Xách', 'Mũ'],
            },
            { label: 'GIÁ MỚI', link: '#', color: '#ff0000' },
            {
              label: 'JEANS',
              subItems: ['Slim Fit', 'Skinny', 'Regular Fit', 'Baggy'],
            },
