      ...
      const fetchProducts = async () => {
        try {
          const res = await fetch(
            "https://huunghi.id.vn/api/viewedProduct/listViewedProduct",
            {
              headers: {
    ...
    toast.info(
      <div className="text-center p-2">
        <p className="text-sm text-gray-700 font-medium">
          Bạn có chắc muốn{" "}
          <span className="text-red-500 font-semibold">xóa tất cả</span> sản
          phẩm đã xem?
        </p>
      ...
      <div className="bg-white border-b max-lg:pt-[190px] max-sm:pt-[90px]">
        <div className="max-w-[1200px] mx-auto">
          <nav className="text-sm text-gray-600 whitespace-nowrap p-3">
            ...
            <span className="font-medium"> / Sản phẩm đã xem</span>
          </nav>
        </div>
      </div>
