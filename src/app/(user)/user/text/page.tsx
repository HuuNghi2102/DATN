...
export default function StatsPage() {
  return (
    <div className="min-h-screen bg-gray-100 p-[11%]">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Thống kê tổng quan</h1>
        ...
        <div className="bg-white rounded-2xl p-6 shadow">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={areaData}>
              ...
              <YAxis />
              <Tooltip />
              <Area type="monotone" dataKey="value" stroke="#4ade80" fillOpacity={1} fill="url(#colorValue)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
