          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-600 mb-4">
                <span>
                  Loại: <strong className="font-semibold">Áo Thun</strong>
                </span>
                <span>
                  MSP: <strong className="font-semibold">ATI00560-01</strong>
                </span>
              </div>
              ...
              <div className="space-y-2 text-sm">
                {promoOffers.map((offer, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    <span>
                      Nhập mã <strong>{offer.code}</strong> GIẢM{" "}
                      {offer.discount} ĐƠN TỪ {offer.minOrder}
                    </span>
                  </div>
                ))}
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed mb-4">
                  ...
                  tốt, giúp da luôn khô thoáng và dễ chịu. Nhờ cấu trúc sợi bông
                  đặt chất, vải cotton có độ bền cao, hạn chế co rút sau nhiều
                  lần giặt.
                </p>
                <p className="text-sm leading-relaxed mb-4">
                  Đồng thời, chất liệu này có khả năng co giãn nhẹ, mang lại sự
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed mb-4">
                  Áo nổi bật với 2 đường sọc tương phản màu áo chạy dài từ có
                  đến vai giúp tạo hiệu ứng cho phần vai trông rộng và cân đối
                  hơn. Logo in nổi ở giữa ngực mang đến sự tính tế và cá tính,
                  tạo điểm nhấn cho tổng thể thiết kế, đặc biệt phù hợp nhiều
                  phong cách khác nhau từ casual đến streetwear.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed mb-4">
                  Form dáng mới nhất tại 160STORE với đường cắt thoáng và phần
                  vai hơi xuôi, tạo nên vẻ ngoài phóng khoáng, hiện đại. Nhờ
                  thiết kế rộng vừa phải, form này giúp che khuyết điểm tốt, phù
                  hợp với nhiều dáng người và vẫn đảm bảo sự thoải mái khi vận
                  động.
                </p>
              </div>
          ...
          {[
            {
              products: Array(5).fill({
                name: "Quần thun co giãn ICM LOTTEPark",
                price: "123123",
              }),
            },
          ].map((section, index) => (
                    ...
                    <div className="bg-white p-2 rounded-lg cursor-pointer">
                      <div className="relative group overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-30 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                          <FontAwesomeIcon
                            icon={faSearch}
                            className="text-white w-4 pointer-events-auto"
                          />
                        </div>
                        <a
                          href="#"
