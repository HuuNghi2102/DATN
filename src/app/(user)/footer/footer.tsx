      ...
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-700 pb-6 mb-6">
          ...
          <form className="flex w-full max-w-md mb-4 md:mb-0">
            ...
            <button
              type="submit"
              className="flex items-center bg-black border border-white text-white font-bold px-4"
            >
          ...
          <div className="flex gap-2">
            <img
              ...
              src="/assets/images/zalo-seeklogo.webp"
              alt="zalo"
            />
            <img
              className="max-w-10 h-10"
              src="/assets/images/Instagram_icon.png.webp"
              alt="instagram"
            />
            <img
              className="max-w-10 h-10"
            ...
            <img
              className="max-w-10 h-10"
              src="/assets/images/2023_Facebook_icon.svg.png"
              alt="facebook"
            />
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-8">
          <div className="min-w-[250px] flex-1">
            ...
            <div className="flex items-start text-sm mb-1">
              <FaPhone className="mr-2 mt-1" /> 02871006789
            </div>
            <div className="flex items-start text-sm mb-1">
              <FaEnvelope className="mr-2 mt-1" /> cs@160store.com
            </div>
            <div className="flex items-start text-sm mb-1">
              <FaClock className="mr-2 mt-1" /> Giờ mở cửa : 08:30 - 22:00
            </div>
            <div className="flex items-start text-sm mb-3">
              <FaHeadphones className="mr-2 mt-1" /> Nhân viên tư vấn phản hồi
              tin nhắn đến 24:00 (Mỗi ngày)
            </div>
            <div className="mt-4">
              <img
                width="120"
                src="/assets/images/vertify.webp"
                alt="cert1"
                className="mb-2"
              />
              <img
                src="https://images.dmca.com/Badges/dmca_protected_16_120.png?ID=9049de26-d97b-48dc-ab97-1e5fcb221fba"
                alt="DMCA"
            ...
            {[
              {
                ...
                address:
                  "297/3 Tô Hiến Thành, Phường 13, Quận 10, TP Hồ Chí Minh",
              },
              {
                city: "HÀ NỘI (2 CH)",
                address:
                  "Số 26 phố Lê Đại Hành, Phường Lê Đại Hành, Quận Hai Bà Trưng, TP Hà Nội",
              },
              {
                city: "CẦN THƠ (2 CH)",
                address:
                  "Số 35 Trần Phú, Phường Cái Khế, Quận Ninh Kiều, TP Cần Thơ, Cần Thơ",
              },
              {
                city: "ĐÀ NẴNG (2 CH)",
              ...
              <div className="mb-4 text-sm" key={index}>
                <div className="font-bold flex items-center">
                  ...
                  {item.city}
                  {item.new && (
                    <span className="text-xs text-red-500 ml-2">New</span>
                  )}
                </div>
                <div className="ml-6">{item.address}</div>
              </div>
            ))}
            <a href="#" className="block mt-2 text-sm font-bold uppercase">
              XEM TẤT CẢ CỬA HÀNG
            </a>
          </div>
