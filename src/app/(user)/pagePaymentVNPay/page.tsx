...
const VNPayPaymentForm = () => {
  ...
  useEffect(() => {
    ...
    if(userLocal && accessTokenLocal && typeTokenLocal && !Number.isNaN(idOrder)){
        const fetchOrder = async () =>{
            const res = await fetch(`https://huunghi.id.vn/api/order/getOrder/${idOrder}`,{
                headers :{
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20 pb-8 px-4 sm:mt-36"> {/* Thêm pt-24 để tránh header */}
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
        <div className="p-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-2xl font-bold text-gray-800">Tạo mới đơn hàng</h3>
            <div className="bg-indigo-100 text-indigo-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
              VNPAY
            </div>
          </div>
          
          <form onSubmit={(e:any) => {handleSubmit();e.preventDefault()}} className="space-y-6">
            {/* Amount Input */}
            <div className="space-y-2">
              ...
              <p className="mt-1 text-xs text-gray-500">Nhập số tiền từ 10,000đ đến 100,000,000đ</p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <input
                    ...
                    className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                  />
                  <label htmlFor="vnpayqr_default" className="ml-3 block text-sm text-gray-700">
                ...
                <div className="grid gap-3">
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <input
                      ...
                      className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                    />
                    <label htmlFor="vnpayqr" className="ml-3 block text-sm text-gray-700">
                      <span className="font-medium">Ứng dụng VNPAYQR</span>
                      <p className="text-xs text-gray-500 mt-1">Quét mã QR qua ứng dụng VNPAY</p>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <input
                      ...
                      className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                    />
                    <label htmlFor="vnbank" className="ml-3 block text-sm text-gray-700">
                      <span className="font-medium">ATM/Tài khoản nội địa</span>
                      <p className="text-xs text-gray-500 mt-1">40 ngân hàng nội địa hỗ trợ</p>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <input
                      ...
                      className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                    />
                    <label htmlFor="intcard" className="ml-3 block text-sm text-gray-700">
                      <span className="font-medium">Thẻ quốc tế</span>
                      <p className="text-xs text-gray-500 mt-1">Visa, Mastercard, JCB</p>
                    </label>
                  </div>
                </div>
            ...
            {/* Language Selection */}
            <div className="space-y-3">
              <h5 className="text-sm font-medium text-gray-700">Ngôn ngữ giao diện:</h5>
              ...
              <div className="flex space-x-4">
                <label className="flex-1 cursor-pointer">
                  ...
                  <div className="p-3 border border-gray-300 rounded-lg text-center peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:ring-1 peer-checked:ring-indigo-500 transition-all">
                    <span className="block text-sm font-medium text-gray-700">Tiếng Việt</span>
                  </div>
                </label>
                ...
                <label className="flex-1 cursor-pointer">
                  ...
                  />
                  <div className="p-3 border border-gray-300 rounded-lg text-center peer-checked:border-indigo-500 peer-checked:bg-indigo-50 peer-checked:ring-1 peer-checked:ring-indigo-500 transition-all">
                    <span className="block text-sm font-medium text-gray-700">English</span>
                  </div>
                </label>
              </div>
            </div>
        ...
        <div className="px-8 py-4 bg-gray-50 border-t border-gray-200">
          <footer className="text-center text-xs text-gray-500">
            ...
            <div className="flex justify-center space-x-4 mt-2">
              <span className="hover:text-indigo-600 cursor-pointer">Điều khoản</span>
              <span className="hover:text-indigo-600 cursor-pointer">Bảo mật</span>
              <span className="hover:text-indigo-600 cursor-pointer">Trợ giúp</span>
            </div>
          </footer>
        </div>
      </div>
